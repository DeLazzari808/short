  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Points summary when no prediction */}
        ...
        <button
          onClick={onContinue}
          className="w-full bg-white/10 hover:bg-white/20 text-white font-bold py-3.5 rounded-2xl transition-all text-sm active:scale-95"
        >
          Próximo perfil →
        </button>
      </motion.div>
